...
class RemoteGroupDeliveryTest {
    ...
    private fun delivery(
        ...
        RemoteGroupDelivery(
            ...
            onMainThread = { it.run() },
            senderUuidFor = { senderUuid },
        )

    private fun msg(group: String = "grepsedawk", text: String = "hi", from: String = "grepsedawk") =
        Payload.ChatToMc(server = "*", namelayerGroup = group, from = from, text = text)
