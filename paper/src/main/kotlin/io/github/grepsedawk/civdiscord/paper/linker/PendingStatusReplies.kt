...
/**
 * In-memory map of request-id -> mc-uuid of the player who triggered the StatusRequest, so
 * when the StatusReply lands we know which player to whisper the result to.
 *
