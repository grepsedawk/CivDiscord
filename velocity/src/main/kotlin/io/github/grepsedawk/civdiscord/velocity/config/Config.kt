...
data class NameLayerDbConfig(
    ...
    override fun toString(): String = "NameLayerDbConfig(host=$host, port=$port, user=$user, password=[REDACTED], database=$database)"
}
...
data class ChatConfig(
    ...
    val burst: Int = 5,
    val refillPerSecond: Double = 1.0,
)
...
data class Config(
    ...
    val namelayerDb: NameLayerDbConfig?,
